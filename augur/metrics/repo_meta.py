...
def forks(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(
            forks_SQL, self.database, params={'repo_group_id': repo_group_id}
        )
        ...
        return pd.read_sql(forks_SQL, self.database, params={'repo_id': repo_id})
...
def fork_count(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(fork_count_SQL, self.database, params={'repo_id': repo_id})
...
def languages(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(languages_SQL, self.database, params={'repo_id': repo_id})
...
def license_declared(self, repo_group_id, repo_id=None):
    ...
    return pd.read_sql(
        license_declared_SQL, self.spdx_db, params={'repo_id': repo_id}
    )
...
def stars(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(
            stars_SQL, self.database, params={'repo_group_id': repo_group_id}
        )
        ...
        return pd.read_sql(stars_SQL, self.database, params={'repo_id': repo_id})
...
def stars_count(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(stars_count_SQL, self.database, params={'repo_id': repo_id})
...
def watchers(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(watchers_SQL, self.database, params={'repo_id': repo_id})
...
def watchers_count(self, repo_group_id, repo_id=None):
    ...
    if not repo_id:
        ...
        return pd.read_sql(
            watchers_count_SQL, self.database, params={'repo_id': repo_id}
        )
